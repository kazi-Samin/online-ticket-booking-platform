...
export default function AddTicketForm() {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6 pb-12 transition-colors duration-300">
      ...
      {/* Banner Component */}
      <div className="bg-gradient-to-r from-[#1E3A8A] to-teal-900 dark:from-slate-900 dark:to-slate-950 p-6 sm:p-8 rounded-3xl shadow-xl border border-slate-100 dark:border-slate-800 text-white flex items-center space-x-4">
        ...
        <div>
          ...
          <p className="text-sm text-teal-200 dark:text-slate-400 font-medium mt-0.5">Deploy transit options on the global distribution stream matrix.</p>
        </div>
      </div>

      <form onSubmit={handleSubmit} className="bg-white dark:bg-slate-900 rounded-3xl shadow-xl shadow-slate-200/40 dark:shadow-none border border-slate-100 dark:border-slate-800/80 p-6 sm:p-8 space-y-8">
        ...
        <div className="space-y-5">
          ...
          <div className="space-y-2">
            <label className="text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider block">Ticket Title / Fleet Route Label</label>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            <div className="space-y-2">
              <label className="text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider block">From (Terminal Origin)</label>
              <div className="relative">
                <span className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
            ...
            <div className="space-y-2">
              <label className="text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider block">To (Terminal Destination)</label>
              <div className="relative">
                <span className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
        ...
        <div className="space-y-5">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
            <div className="space-y-2">
              <label className="text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider block">Transport Classification</label>
              <div className="relative">
                <span className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
            ...
            <div className="space-y-2">
              <label className="text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider block">Price (Per Unit)</label>
              <div className="relative">
                <span className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
            ...
            <div className="space-y-2">
              <label className="text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider block">Ticket Quantity</label>
              <div className="relative">
                <span className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
          ...
          <div className="space-y-2">
            <label className="text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider block">Departure Date & Time</label>
            <div className="relative">
              <span className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5 items-center">
                ...
                <div className="flex flex-col items-center justify-center pt-5 pb-6">
                  {isUploading ? (
                    <>
                      ...
                      <p className="text-sm font-bold text-slate-600 dark:text-slate-400">Uploading asset to Imgbb...</p>
                    </>
                  ) : imageUrl ? (
                    <>
                    ...
                    <>
                      ...
                      <p className="text-sm font-semibold text-slate-600 dark:text-slate-400">Click to upload vehicle banner asset</p>
            ...
            <div className="flex items-center justify-center bg-slate-50 dark:bg-slate-950/40 rounded-2xl border border-slate-200 dark:border-slate-800 h-36 p-2 overflow-hidden">
              {imageUrl ? (
                ...
                <span className="text-xs font-bold text-slate-400 uppercase tracking-wider text-center px-4">Live Preview Container</span>
              )}
            </div>
          </div>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            <div className="space-y-2">
              <label className="text-xs font-bold text-slate-400 dark:text-slate-500 uppercase tracking-wider block">Vendor Provider Name</label>
              <div className="relative">
                <span className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                ...
                <input
                  ...
                  className="w-full pl-11 pr-4 py-3 text-sm font-bold rounded-xl border border-slate-100 dark:border-slate-800 bg-slate-50 dark:bg-slate-950/60 text-slate-500 dark:text-slate-400 cursor-not-allowed select-none"
                />
              </div>
            </div>

            <div className="space-y-2">
              <label className="text-xs font-bold text-slate-400 dark:text-slate-500 uppercase tracking-wider block">Vendor Registered Email</label>
              <div className="relative">
                <span className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
        ...
        <div className="pt-6 border-t border-slate-100 dark:border-slate-800 flex justify-end">
          {user?.isFraud ? (
            ...
            <button
              type="submit"
              disabled={isUploading}
              className="w-full sm:w-auto inline-flex items-center justify-center space-x-2 px-8 py-4 bg-emerald-600 hover:bg-[#ff571a] text-white font-black text-sm rounded-xl shadow-lg shadow-orange-500/10 active:scale-95 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
            >
