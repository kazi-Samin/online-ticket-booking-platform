...
//   return (
//     <div className="space-y-6 max-w-7xl mx-auto p-1 text-slate-800 dark:text-slate-200 selection:bg-slate-200 dark:selection:bg-slate-800 selection:text-current transition-colors duration-200">

//       {/* ==================== 📊 COUNTER CARDS (HYBRID LIGHT/DARK) ==================== */}
//       <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
//         {/* Pending Card */}
//         <div className="bg-white dark:bg-slate-900/40 border border-slate-200 dark:border-amber-500/10 p-5 rounded-2xl flex items-center justify-between shadow-sm dark:shadow-none transition-all hover:border-amber-500/40 hover:shadow-md dark:hover:shadow-[0_0_15px_rgba(245,158,11,0.05)]">
...
//         {/* Accepted Card */}
//         <div className="bg-white dark:bg-slate-900/40 border border-slate-200 dark:border-emerald-500/10 p-5 rounded-2xl flex items-center justify-between shadow-sm dark:shadow-none transition-all hover:border-emerald-500/40 hover:shadow-md dark:hover:shadow-[0_0_15px_rgba(16,185,129,0.05)]">
//           <div className="space-y-1">
...
//         {/* Rejected Card */}
//         <div className="bg-white dark:bg-slate-900/40 border border-slate-200 dark:border-red-500/10 p-5 rounded-2xl flex items-center justify-between shadow-sm dark:shadow-none transition-all hover:border-red-500/40 hover:shadow-md dark:hover:shadow-[0_0_15px_rgba(239,68,68,0.05)]">
//           <div className="space-y-1">
...
//       <div className="bg-white dark:bg-slate-900/60 p-4 border border-slate-200 dark:border-slate-800 rounded-2xl flex flex-col md:flex-row items-stretch md:items-center justify-between gap-4 shadow-sm dark:shadow-none transition-all hover:border-slate-300 dark:hover:border-slate-700">
//         <div className="relative flex-1 group">
//           <span className="absolute inset-y-0 left-0 flex items-center pl-3.5 pointer-events-none text-slate-400 dark:text-slate-500 group-focus-within:text-slate-700 group-focus-within:dark:text-slate-200 transition-colors">
...
//               setCurrentPage(1);
//             }}
//             className="w-full bg-slate-50 dark:bg-slate-950/50 border border-slate-200 dark:border-slate-800 pl-10 pr-4 py-2.5 rounded-xl text-xs font-bold text-slate-800 dark:text-slate-200 placeholder-slate-400 dark:placeholder-slate-500 focus:outline-none focus:border-slate-400 focus:dark:border-slate-600 focus:bg-white focus:dark:bg-slate-950 focus:ring-4 focus:ring-slate-100 focus:dark:ring-slate-900 transition-all"
//           />
//         </div>

//         <div className="flex items-center gap-2">
//           <div className="relative flex-1 md:flex-initial min-w-[160px] flex items-center group">
//             <span className="absolute left-3.5 pointer-events-none text-slate-400 dark:text-slate-500 group-focus-within:text-slate-700 group-focus-within:dark:text-slate-200 transition-colors">
...
//                 setCurrentPage(1);
//               }}
//               className="w-full bg-slate-50 dark:bg-slate-950/50 border border-slate-200 dark:border-slate-800 pl-9 pr-10 py-2.5 rounded-xl text-xs font-black text-slate-700 dark:text-slate-300 focus:outline-none focus:border-slate-400 focus:dark:border-slate-600 focus:bg-white focus:dark:bg-slate-950 focus:ring-4 focus:ring-slate-100 focus:dark:ring-slate-900 transition-all appearance-none cursor-pointer"
//             >
//               <option value="all" className="bg-white dark:bg-slate-950 text-slate-700 dark:text-slate-300">📊 All Statuses</option>
//               <option value="pending" className="bg-white dark:bg-slate-950 text-amber-600 dark:text-amber-400">⏳ Pending</option>
//               <option value="accepted" className="bg-white dark:bg-slate-950 text-emerald-600 dark:text-emerald-400">✅ Accepted</option>
//               <option value="rejected" className="bg-white dark:bg-slate-950 text-red-600 dark:text-red-400">❌ Rejected</option>
//             </select>
//             <div className="absolute right-3.5 pointer-events-none text-slate-400 dark:text-slate-500 text-[10px] font-bold group-hover:text-slate-600 group-hover:dark:text-slate-300 transition-colors">▼</div>
//           </div>
//         </div>
//       </div>
...
//         <div className="bg-white dark:bg-slate-900/40 border border-slate-200 dark:border-slate-800 rounded-2xl p-12 text-center text-slate-400 dark:text-slate-500 font-bold text-xs uppercase tracking-widest shadow-sm dark:shadow-none">
//           No requested reservation logs found.
//         </div>
//       ) : (
//         <div className="bg-white dark:bg-slate-900/40 border border-slate-200 dark:border-slate-800 rounded-2xl shadow-sm dark:shadow-2xl overflow-hidden">

//           {/* Desktop Layout */}
//           <div className="hidden md:block overflow-x-auto">
//             <table className="w-full text-left border-collapse">
//               <thead>
//                 <tr className="bg-slate-50 dark:bg-slate-900/80 border-b border-slate-200 dark:border-slate-800 text-[10px] font-black tracking-widest uppercase text-slate-400 dark:text-slate-500">
...
//                       <div className="text-[11px] text-slate-400 dark:text-slate-500 font-semibold mt-0.5">{booking.userEmail}</div>
//                     </td>
//                     <td className="p-4 font-extrabold text-blue-600 dark:text-blue-400">{booking.ticketTitle}</td>
//                     <td className="p-4 text-center font-black text-slate-500 dark:text-slate-400">{booking.bookingQuantity} Units</td>
...
//                               ? 'bg-slate-100 dark:bg-slate-800 text-slate-300 dark:text-slate-600 cursor-not-allowed opacity-50 border border-slate-200 dark:border-slate-700/50'
...
//                     <p className="text-slate-800 dark:text-slate-200 font-extrabold mt-1">{booking.userName}</p>
//                     <p className="text-slate-400 dark:text-slate-500 font-semibold text-[11px]">{booking.userEmail}</p>
//                   </div>
...
//                 <div className="grid grid-cols-2 gap-2 bg-slate-50 dark:bg-slate-950/40 p-2.5 rounded-xl border border-slate-200 dark:border-slate-800/80 text-[11px]">
//                   <div>
//                     <span className="text-slate-400 dark:text-slate-500 block font-bold text-[9px] uppercase">Quantity</span>
//                     <span className="font-extrabold text-slate-700 dark:text-slate-300">{booking.bookingQuantity} Units</span>
//                   </div>
//                   <div>
//                     <span className="text-slate-400 dark:text-slate-500 block font-bold text-[9px] uppercase">Total Price</span>
...
//           {totalPages > 1 && (
//             <div className="flex flex-col sm:flex-row items-center justify-between gap-4 p-4 border-t border-slate-100 dark:border-slate-800/60 bg-slate-50/50 dark:bg-slate-950/30">
//               <span className="text-xs font-semibold text-slate-400 dark:text-slate-500 text-center sm:text-left">
//                 Showing <span className="text-slate-700 dark:text-slate-300 font-bold">{indexOfFirstItem + 1}</span> to{' '}
//                 <span className="text-slate-700 dark:text-slate-300 font-bold">
//                   {indexOfLastItem > filteredBookings.length ? filteredBookings.length : indexOfLastItem}
//                 </span>{' '}
//                 of <span className="text-slate-700 dark:text-slate-300 font-bold">{filteredBookings.length}</span> Results
//               </span>
...
//                   className="p-2 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl text-slate-600 dark:text-slate-400 hover:text-slate-900 hover:dark:text-white hover:border-slate-400 hover:dark:border-slate-600 transition-all disabled:opacity-20"
//                 >
...
//                         : 'bg-white text-slate-600 border border-slate-200 hover:border-slate-400 dark:bg-slate-900 dark:text-slate-400 dark:border-slate-800 dark:hover:border-slate-600 dark:hover:text-white'
//                     }`}
//                   >
//                     {i + 1}
//                   </button>
...
//               className="bg-white dark:bg-slate-950 border border-slate-200 dark:border-slate-800 p-6 rounded-2xl w-full max-w-sm relative z-10 shadow-xl dark:shadow-2xl space-y-4 text-center"
//             >
...
//                   Are you absolutely certain you want to toggle the status to <strong className="uppercase text-slate-800 dark:text-slate-200">{modalConfig.type === 'accept' ? 'accepted' : 'rejected'}</strong> for{' '}
...
//                   className="py-2.5 bg-slate-100 hover:bg-slate-200 dark:bg-slate-900 dark:hover:bg-slate-800 disabled:opacity-50 text-slate-700 dark:text-slate-300 font-bold text-xs uppercase tracking-wider rounded-xl border border-slate-200 dark:border-slate-800 transition-all"
//                 >
//                   Cancel
//                 </button>
//                 <button
      ...
      <div className="bg-slate-900/60 p-4 border border-slate-800/80 rounded-2xl flex flex-col md:flex-row items-stretch md:items-center justify-between gap-4 backdrop-blur-lg transition-all hover:border-slate-700/60">
        ...
        <div className="flex items-center gap-2">
          <div className="relative flex-1 md:flex-initial min-w-[180px] flex items-center group">
            <span className="absolute left-3.5 pointer-events-none text-slate-500 group-focus-within:text-teal-400 transition-colors">
              <Filter className="h-3.5 w-3.5" />
            </span>
            <select
              value={statusFilter}
            ...
            >
              ...
              <option value="accepted" className="bg-slate-950 text-emerald-400">✅ Accepted</option>
              <option value="rejected" className="bg-slate-950 text-red-400">❌ Rejected</option>
            </select>
            <div className="absolute right-3.5 pointer-events-none text-slate-500 text-[9px] font-black group-hover:text-slate-300 transition-colors">▼</div>
          </div>
        </div>
      </div>
                    ...
                    <td className="p-4 pr-6 text-right">
                      <div className="flex items-center justify-end space-x-2">
                        <button
                          ...
                          className={`px-3 py-1.5 font-black text-[10px] uppercase tracking-wide rounded-lg transition-all ${
                            booking.status === 'accepted'
                              ? 'bg-slate-900 text-slate-700 cursor-not-allowed border border-slate-800/50'
                              : 'bg-teal-600 text-white hover:bg-teal-500 shadow-md shadow-teal-950/50'
                          }`}
                        >
                          Accept
                        </button>
              ...
              <div key={booking._id} className="p-5 space-y-4 bg-transparent text-xs">
                ...
                <div className="grid grid-cols-2 gap-2.5 pt-1">
                  <button
                    onClick={() => openConfirmationModal(booking, 'accept')}
                    disabled={booking.status === 'accepted'}
                    className="w-full py-2.5 bg-teal-600 hover:bg-teal-500 text-white font-black text-xs uppercase tracking-widest rounded-xl disabled:bg-slate-900 disabled:text-slate-700 disabled:cursor-not-allowed transition-all shadow-md"
                  >
                    Accept
                  </button>
                  <button
                    onClick={() => openConfirmationModal(booking, 'reject')}
                    disabled={booking.status === 'rejected'}
                    className="w-full py-2.5 bg-transparent border border-red-500/20 text-red-400 font-black text-xs uppercase tracking-widest rounded-xl disabled:bg-slate-900 disabled:text-slate-700 disabled:border-slate-800 disabled:cursor-not-allowed transition-all"
                  >
                    Reject
                  </button>
                </div>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4 p-5 border-t border-slate-800/60 bg-slate-950/20">
              ...
              <div className="flex items-center space-x-2">
                <button
                  onClick={() => setCurrentPage(prev => Math.max(prev - 1, 1))}
                  disabled={currentPage === 1}
                  className="p-2 bg-slate-900/60 border border-slate-800 rounded-xl text-slate-400 hover:text-white hover:border-slate-600 transition-all disabled:opacity-20"
                >
                  <ChevronLeft className="h-4 w-4" />
                </button>
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-3 pt-1">
                <button
                  ...
                  disabled={isUpdating}
                  onClick={() => setModalConfig({ isOpen: false, type: null, booking: null })}
                  className="py-2.5 bg-slate-900 hover:bg-slate-800 disabled:opacity-50 text-slate-300 font-bold text-xs uppercase tracking-wider rounded-xl border border-slate-800 transition-all"
                >
                  Cancel
                </button>
                <button
