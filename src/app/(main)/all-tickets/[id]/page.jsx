...
const TicketDetailsPage = async ({ params }) => {
  ...
  if (!ticket) {
    return (
      ...
      <div className="min-h-screen bg-slate-950 flex items-center justify-center">
        ...
        <p className="text-xs font-black uppercase tracking-widest text-slate-500 bg-slate-950/40 border border-slate-900/60 px-5 py-3 rounded-xl relative z-10 shadow-lg">
  ...
  return (
    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 antialiased p-4 sm:p-8 transition-colors duration-300 relative overflow-hidden">
      {/* Strategic Organic Gradient Bleed Ring Layouts */}
      <div className="absolute top-0 right-1/4 w-[400px] h-[400px] bg-teal-600/5 rounded-full blur-[100px] pointer-events-none" />
