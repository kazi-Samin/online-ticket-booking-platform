...
const AllTickets = async ({ searchParams }) => {
  ...
  return (
    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 antialiased p-4 sm:p-8 selection:bg-teal-500/20">
      <div className="max-w-7xl mx-auto space-y-8 text-left">
        
        {/* Header Hero Board Panel */}
        <div className="relative overflow-hidden bg-slate-900/30 backdrop-blur-md border border-slate-800/80 p-6 sm:p-8 rounded-[24px] shadow-xl flex flex-col md:flex-row md:items-center justify-between gap-6">
          ...
          <div className="bg-slate-950/60 border border-slate-800 px-5 py-3 rounded-xl self-start md:self-auto shadow-inner">
