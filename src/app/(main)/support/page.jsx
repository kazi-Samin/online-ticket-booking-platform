...
const contactMethods = [
  ...
  { icon: <Phone className="h-5 w-5 text-indigo-600 dark:text-indigo-400" />, title: "Call Hotline", value: "+44 20 7946 0958", sub: "24/7 Instant Transit Expert Line" },
    ...
    <main className="bg-zinc-50 dark:bg-[#0F172A] text-zinc-900 dark:text-slate-100 min-h-screen py-16 px-4 transition-colors duration-300">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-indigo-50 dark:bg-indigo-950/40 text-indigo-600 dark:text-indigo-400 text-xs font-black uppercase tracking-widest mb-3 border border-indigo-100 dark:border-indigo-900/30">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start mb-20">
          ...
          <div className="lg:col-span-5 space-y-3">
            {contactMethods.map((c, i) => (
              <motion.div
                ...
                className="p-4 bg-white dark:bg-slate-900 border border-zinc-200 dark:border-slate-800/80 rounded-[20px] flex gap-3.5 items-center shadow-sm transition-all duration-200 hover:border-indigo-500/30"
              >
          ...
          <motion.div
            ...
            className="lg:col-span-7 bg-white dark:bg-slate-900 p-6 rounded-[28px] border border-zinc-200 dark:border-slate-800/80 shadow-sm transition-colors duration-200"
          >
            <div className="flex items-center gap-2 text-zinc-950 dark:text-white font-black text-base tracking-tight mb-5">
              <MessageSquare className="h-4 w-4 text-indigo-600 dark:text-indigo-400" /> Instant Support Ticket
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-zinc-50 dark:bg-slate-950 border border-zinc-200 dark:border-slate-800 text-zinc-950 dark:text-white placeholder-zinc-400 focus:border-indigo-500 dark:focus:border-indigo-400 focus:bg-white dark:focus:bg-slate-900 rounded-xl px-4 py-3 text-xs sm:text-sm font-semibold outline-none transition-all duration-200"
              ...
              <button
                type="submit"
                className="w-full sm:w-auto px-6 py-3 bg-gradient-to-r from-indigo-600 to-blue-600 hover:from-indigo-500 hover:to-blue-500 text-white font-black text-xs rounded-xl flex items-center justify-center gap-2 shadow-md hover:shadow-lg transition-all duration-300 uppercase tracking-widest"
              >
        ...
        <div className="border-t border-zinc-200/80 dark:border-slate-800 pt-14">
          <div className="flex items-center gap-2 text-zinc-950 dark:text-white font-black text-lg sm:text-xl tracking-tight mb-6">
            <HelpCircle className="h-5 w-5 text-indigo-600 dark:text-indigo-400" /> Frequently Asked Questions
          </div>
              ...
              return (
                ...
                >
                  ...
                  >
                    ...
                    <ChevronDown
                      className={`h-4 w-4 text-zinc-400 shrink-0 transition-transform duration-300 ${isOpen ? 'rotate-180 text-indigo-600 dark:text-indigo-400' : ''}`}
                    />
                  </button>
