...
export default function NotFound() {
  return (
    <div className="min-h-screen bg-[#09090b] text-zinc-400 flex flex-col items-center justify-center relative overflow-hidden px-4 select-none">
      ...
      <div className="absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-indigo-600/5 rounded-full blur-[140px] pointer-events-none" />
      ...
      <div className="relative z-10 max-w-xl text-center space-y-8 flex flex-col items-center">
        ...
        <div className="relative">
          ...
          <div className="absolute -bottom-2 left-1/2 -translate-x-1/2 px-3 py-1 bg-indigo-600 text-white text-[10px] font-black tracking-widest uppercase rounded-md shadow-lg shadow-indigo-500/20 whitespace-nowrap border border-indigo-500/30">
            Route Not Found
          </div>
        </div>

        {/* Dynamic Ticket Terminal Lost Panel Concept */}
        <div className="w-full max-w-sm bg-zinc-900/20 backdrop-blur-md border border-zinc-800/80 rounded-2xl p-6 relative overflow-hidden group">
          ...
          <div className="py-4 flex flex-col items-center space-y-4">
            ...
            <div className="animate-bounce duration-1000 text-zinc-600 group-hover:text-indigo-400 transition-colors">
              <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-indigo-600/10 text-indigo-400 border border-indigo-500/20 group-hover:bg-indigo-600 group-hover:text-white transition-all duration-300 transform -rotate-12">
            ...
            <div className="space-y-1.5 px-2">
              <h4 className="text-sm font-black text-zinc-200">Terminal Disconnection</h4>
              <p className="text-xs font-medium tracking-wide text-zinc-500 text-center leading-relaxed">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-4 w-full sm:w-auto">
          <Link
            href="/"
            className="w-full sm:w-auto inline-flex items-center justify-center space-x-2 px-8 py-3.5 bg-indigo-600 hover:bg-indigo-500 border border-indigo-500/30 text-white font-black text-sm rounded-xl shadow-lg shadow-indigo-500/10 active:scale-95 transition-all"
          >
