...
import { FaUser, FaEnvelope, FaLock, FaGoogle, FaArrowRight, FaTicketAlt, FaEye, FaEyeSlash } from 'react-icons/fa';
  ...
  return (
    <div className="w-full min-h-screen bg-slate-50 dark:bg-slate-950 flex relative overflow-hidden transition-colors duration-300">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative bg-slate-100 dark:bg-slate-900 items-center justify-center p-12 overflow-hidden border-r border-slate-200 dark:border-slate-800/50">
        ...
        <div className="absolute inset-0 bg-gradient-to-tr from-teal-900/40 via-slate-100/70 to-slate-50/90 dark:from-teal-950/80 dark:via-slate-900/60 dark:to-slate-950/95" />
        ...
        <div className="relative z-10 max-w-md space-y-6">
          ...
          <blockquote className="space-y-4">
            ...
            <div className="text-sm font-semibold text-teal-600 dark:text-teal-400 tracking-wider uppercase">
        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <div>
            <h2 className="text-3xl font-black text-slate-900 dark:text-white tracking-tight">
              Get <span className="text-teal-600 dark:text-teal-400">Started</span>
            </h2>
            <p className="text-slate-600 dark:text-slate-400 text-sm mt-2 font-medium">Create a secure unified user account to start planning journeys</p>
          </div>
          ...
          <form onSubmit={handleRegister} className="space-y-5">
            <div className="space-y-2">
              <label className="text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-widest pl-0.5">Full Name</label>
              <div className="relative">
                <span className="absolute inset-y-0 left-0 flex items-center pl-4 text-slate-400 dark:text-slate-500"><FaUser /></span>
                <input 
                  type="text" 
                  value={name}
            ...
            <div className="space-y-2">
              <label className="text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-widest pl-0.5">Password</label>
              <div className="relative">
          ...
          <p className="text-center text-sm text-slate-600 dark:text-slate-400 font-medium pt-2">
            Already have an account? <Link href="/login" className="text-teal-600 dark:text-teal-400 font-bold hover:underline">Sign In</Link>
          </p>
