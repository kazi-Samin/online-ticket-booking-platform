...
const MyAddedTickets = async () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-black text-slate-800 dark:text-slate-200 transition-colors duration-300 text-left">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">

        {/* ==================== 🏆 ULTRA-MODERN BRAND HEADER & COUNTER ==================== */}
        <div className="relative overflow-hidden bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-6 rounded-3xl shadow-xs flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
          ...
          <div className="inline-flex items-center gap-2.5 bg-blue-50 dark:bg-blue-500/10 border border-blue-200 dark:border-blue-500/20 rounded-2xl px-4 py-2.5 self-start sm:self-center shadow-xs relative z-10 select-none">
            ...
            <p className="text-xs font-black text-slate-800 dark:text-slate-300 tracking-wider uppercase">
