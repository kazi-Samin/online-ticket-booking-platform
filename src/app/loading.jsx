...
export default function Loading() {
  return (
    ...
    <div className="fixed inset-0 z-50 flex flex-col items-center justify-center bg-slate-950 text-slate-400 select-none transition-colors duration-300">

      {/* Absolute Background Custom Indigo/Violet Glow Matrix */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[400px] h-[400px] bg-teal-600/10 rounded-full blur-[100px] pointer-events-none" />
      ...
      <div className="w-full max-w-sm flex flex-col items-center space-y-6 px-6 relative z-10">
        ...
        <div className="relative w-full h-16 overflow-hidden flex flex-col justify-end">
          ...
          <div className="animate-bus absolute bottom-2 left-0 text-teal-500">
        ...
        <div className="text-center space-y-1.5">
          ...
          <h3 className="text-sm font-black tracking-[0.2em] text-slate-100 uppercase animate-pulse">
            Ticket<span className="text-teal-400">Core</span> Terminal
          </h3>
